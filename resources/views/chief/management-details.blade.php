...
@section('content')
  ...
  <div class="main gap">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
          <div class="row">
              <div class="col-md-12">
                <h2>{{ $management_detail->heading }}</h2>
                <div class="m-image"><img src="{{ asset($management_detail->image)}}" alt=""></div>
                <h5>{{ $management_detail->name }}</h5>
                <p>{{ $management_detail->heading }}</p>
                <p>{{ $management_detail->zilla }}</p>
                <p>{{ $management_detail->phone }}</p>
                <p>{{ $management_detail->mobile }}</p>
        ...
        @foreach ($chiefs as $chief)
          <div class="execphpwidget">
              <div class="rightBarBlock">
                  ...
                  <img width="150px" height="150px"src="{{ asset($chief->image) }}" alt="director">
